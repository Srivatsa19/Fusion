        ...
        <div>
            ...
            <div className='ml-10'>
                {bookings?.length > 0 && bookings.map(booking => (
                    <div className="mb-3">
                        <Link to={`/account/bookings/${booking._id}`} className='flex gap-4 bg-gray-200 rounded-2xl overflow-hidden mr-10'>
                            <div className='w-48'>
                            ...
                            <div className='pr-2 grow'>
                                <div className="">
                                    ...
                                    <div className='border-t border-gray-300 mt-2 py-2 flex items-center gap-1'>
